...
//         // minHeap을 int[] 형태로 변환
//         int[] minHeapArray = new int[list1.size()];
//         for (int i = 0; i < list1.size(); i++) {
//             minHeapArray[i] = list1.get(i);
//         }

//         // maxHeap을 int[] 형태로 변환  
//         int[] maxHeapArray = new int[list2.size()];
//         for (int i = 0; i < list2.size(); i++) {
//             maxHeapArray[i] = list2.get(i);
//         }
//         return minHeapArray;
        // int[] aaa = new int[minHeap.size()];
        // int index = 0;
        // while (!minHeap.isEmpty()) {
        //     aaa[index++] = minHeap.poll();
        // }
        // return aaa;
        return result;
    }
